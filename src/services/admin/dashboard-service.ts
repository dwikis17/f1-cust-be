...
import { DashboardRepository } from "../../repositories/admin/dashboard-repository.js";
...
export class DashboardService {
  static async summary(period: DashboardPeriod, now = new Date()) {
    ...
    const {
      ...
      packing,
      bookingFailed,
    } = await DashboardRepository.summarySources({ startAt, endAt, previousStartAt, previousEndAt });
